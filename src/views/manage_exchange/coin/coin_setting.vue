<template>
    <Card class="coin_setting" style="background: #fff;position:relative;">
        <i @click="closeDialog" class="ivu-icon ivu-icon-close" style="float:right;cursor:pointer;z-index:101;"></i>
        <Tabs style="backgroung:#fff;z-index:100;">
