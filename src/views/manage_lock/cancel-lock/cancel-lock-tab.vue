...
<script>
    export default {
        ...
        created() {
            this.column = [
                {key: 'cancelId', title: this.vm.$t('lock.jscid')},
                {key: 'username', title: this.vm.$t('common.yhm')},
                {key: 'minerId', title: this.vm.$t('lock.mbscjlid')},
                {key: 'symbol', title: this.vm.$t('common.bz')},
                {key: 'totalAmount', title: this.vm.$t('lock.scsl')},
                {key: 'remainAmount', title: this.vm.$t('lock.sysl')},
                {
                ...
                {key: 'remainAmount', title: this.vm.$t('lock.fhdyhm')},
                {
                ...
                {key: 'operateUser', title: this.vm.$t('system.cjr')},
