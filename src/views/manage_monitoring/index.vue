...
<script>
    ...
    export default {
                        ...
                        render: (h, params) => {
                            return h('div', [
                                h('Button', {
                                    ...
                                    on: {
                                        click: () => {
                                            monitorApi.ignoreWithdrawApply({
        ...
        methods: {
            ...
            select () {
                monitorApi.findFailWithdrawApplyList(this.curPage, this.params, (res, total) => {
                    this.total = total;
                    this.data9 = res;
                }, (msg) => {
                    this.$Message.error({content: msg});
            ...
            getApplyList () {
                monitorApi.findFailWithdrawApplyList(this.curPage, {}, (res, total) => {
                    this.total = total;
                    this.data9 = res;
                }, (msg) => {
                    this.$Message.error({content: msg});
